...
export default function SiteFooter({ navLinks = [], metaLinks = [] }: SiteFooterProps) {
  return (
    <footer className="dark w-full bg-[radial-gradient(ellipse_at_5%_50%,hsl(240,5%,10%)_0%,hsl(240,5%,10%)_70%,#37093F_100%)] text-foreground">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-6">
          <div
            aria-hidden
            className="h-px w-full bg-gradient-to-r from-accent to-muted-foreground/70"
          />
