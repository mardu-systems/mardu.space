        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <p className="mb-3 [font-size:_clamp(0.1em,3vw,2em)] md:max-w-[450px] md:text-2xl md:pb-8 md:px-0 px-[20vw]">
                            Wir verwenden erforderliche, leistungsbezogene und Marketing-Cookies, um Ihre Erfahrung zu
                            messen,
                            zu analysieren und zu personalisieren. Mehr dazu in unserer{" "}
