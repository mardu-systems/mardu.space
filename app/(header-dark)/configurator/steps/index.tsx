...
) => [
    {
        ...
        view: (
            <NumberStep
                ...
                onChange={(v) =>
                    setState((p) => ({...p, triMachines: {...p.triMachines, count: v}}))
                }
            />
        ),
    ...
    },
    {
        ...
        view: (
            <NumberStep
                ...
                onChange={(v) =>
                    setState((p) => ({...p, doors: {...p.doors, count: v}}))
                }
            />
        ),
    ...
    },
    {
        ...
        view: (
            <NumberStep
                ...
                onChange={(v) =>
                    setState((p) => ({...p, gates: {...p.gates, count: v}}))
                }
            />
        ),
    ...
    },
    {
        ...
        view: (
            <NumberStep
                ...
                onChange={(v) =>
                    setState((p) => ({...p, fridges: {...p.fridges, count: v}}))
                }
    ...
    },
    {
        ...
        view: (
            <NumberStep
                ...
                onChange={(v) =>
                    setState((p) => ({...p, centralRooms: {...p.centralRooms, count: v}}))
                }
            />
        ),
