            ...
            <Card className="rounded-2xl">
                <CardContent className="p-6">
                    ...
                    <div className="mt-4 text-xs text-ink-400">
                        <p>
                            Zweiadriges Kabel gesamt (ca.): <strong
                            className="text-ink-600">{totalCable2core} m</strong>
                        </p>
                        <p>
                            12‑adriges Kabel gesamt (ca.): <strong
                            className="text-ink-600">{totalCable12core} m</strong>
                        </p>
                    </div>
                </CardContent>
            </Card>
...
function computeBOM(state: State): BomRow[] {
    const map = new Map<string, { qty: number; note?: string }>();
    ...
    return Array.from(map.entries()).map(([item, {qty, note}]) => ({
        item,
        qty,
        note,
    }));
