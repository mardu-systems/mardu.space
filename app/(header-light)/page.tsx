    ...
    <main className="relative min-h-screen bg-background text-foreground">
      ...
      <section className="relative w-full h-[calc(100vh-8rem)]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center animate-in fade-in slide-in-from-bottom-8 duration-700">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl text-neutral-300 font-bold leading-tight mb-6">
              Zugriffskontrollsysteme für Makerspaces, FabLabs und Schülerlabore
            </h1>

            <p className="text-lg sm:text-xl text-neutral-300/90 mb-8 leading-relaxed">
      ...
      <section className="relative w-full">
        <div className="flex items-end justify-center">
          <div className="text-center">
            <h2 className="uppercase font-futura-heavy text-[clamp(20px,4vw,80px)] text-primary md:leading-[0.9] animate-in fade-in slide-in-from-bottom-4 duration-700 pt-11">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8">
            <div className="grid grid-cols-12 gap-6 md:gap-10 items-center">
              ...
              <div className="col-span-7 md:col-span-4">
                <div className="font-futura-normal text-accent text-sm sm:text-base leading-snug tracking-[0.005em]">
                  <p>
            ...
            <div className="grid grid-cols-12 gap-6 md:gap-10 items-start">
              ...
              <div className="col-span-12 md:col-span-6 grid grid-rows-[auto_auto_1fr]">
                <div className="flex items-start gap-4">
                  ...
                  <div className="mt-4 max-w-[40ch] font-futura-normal text-accent text-sm sm:text-base leading-snug tracking-[0.005em]">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8">
            <div className="grid grid-cols-12 gap-6 md:gap-10 items-start">
              <div className="col-span-11 md:col-span-6 relative">
                ...
                <div className="md:absolute relative font-futura-normal text-accent text-sm sm:text-base leading-snug tracking-[0.005em] flex items-start gap-4 max-w-[280px] md:max-w-[340px] md:left-[45%] md:bottom-[7%] mt-6 md:mt-0 pointer-events-none">
              ...
              <figure className="col-span-12 md:col-span-5 flex flex-col items-center md:items-end md:self-end">
                <Image
                  ...
                  loading="lazy"
                />
                <figcaption className="font-futura-normal mt-3 text-center md:text-left text-xl leading-snug">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8">
            <div className="grid grid-cols-12 gap-6 md:gap-10 items-center">
              ...
              <div className="col-span-12 md:col-span-6 flex items-start gap-4">
                ...
                <div className="font-futura-normal text-accent text-sm sm:text-base leading-snug tracking-[0.005em] max-w-[56ch]">
                  <p>
