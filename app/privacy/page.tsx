                    ...
                    <CardContent className="space-y-6 text-sm leading-relaxed">
                        <section>
                            ...
                            <div className="space-y-1">
                                ...
                                <p>[PLZ Ort]</p>
                                <p>E-Mail:
                                    <a href="mailto:info@mardu.space" className="underline ml-1 text-blue-600">
                                        info@mardu.space
                                    </a>
                                </p>
                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <h3 className="font-medium mb-2">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h3>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Andere Daten werden automatisch beim Besuch der Website durch unsere IT-Systeme erfasst. Das sind vor allem technische Daten (z.B. Internetbrowser, Betriebssystem oder Uhrzeit des Seitenaufrufs).</p>
                                </div>
                        ...
                        <section>
                            <h2 className="font-semibold text-lg mb-3">4. Hosting und Content Delivery Networks (CDN)</h2>
                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <h3 className="font-medium mb-2">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Eine Zusammenführung dieser Daten mit anderen Datenquellen wird nicht vorgenommen. Grundlage für die Datenverarbeitung ist Art. 6 Abs. 1 lit. f DSGVO, der die Verarbeitung von Daten zur Erfüllung eines Vertrags oder vorvertraglicher Maßnahmen gestattet.</p>
                                </div>

                                <div>
                                    <h3 className="font-medium mb-2">Kontaktformular</h3>
                                    <p>Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben aus dem Anfrageformular inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und für den Fall von Anschlussfragen bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.</p>
                                    <p className="mt-2">Die Verarbeitung der in das Kontaktformular eingegebenen Daten erfolgt somit ausschließlich auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Sie können diese Einwilligung jederzeit widerrufen.</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <p>Wir verwenden derzeit keine Analyse-Tools oder Werbemittel auf dieser Website. Sollte sich dies ändern, werden wir Sie entsprechend informieren und diese Datenschutzerklärung aktualisieren.</p>
                        </section>

                        <section>
                            <h2 className="font-semibold text-lg mb-3">8. Plugins und Tools</h2>
                            <p>Diese Website verwendet derzeit keine externen Plugins oder Tools von Drittanbietern. Sollte sich dies ändern, werden wir Sie entsprechend informieren und diese Datenschutzerklärung aktualisieren.</p>
                        </section>
